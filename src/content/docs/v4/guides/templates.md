---
title: Templates
description: Declare a group of objects or table members once and reuse it
  across schemas and tables
sidebar:
  order: 45
slug: v4/guides/templates
---
...
A schema template can also carry [`SCRIPT` statements](/v4/guides/data-migrations/#migrations-in-templates) for the tables
