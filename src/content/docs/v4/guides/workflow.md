...
If you've configured a [state store](/v4/guides/state/), the `plan` command will run **offline** against the last recorded
...
See [Running in CI](/v4/guides/ci/) for the full pipeline pattern.

## Tearing down

To preview or execute a teardown of the managed schema, see [`plan --destroy`](/v4/cli/commands/plan/#previewing-a-teardown) and
[`destroy`](/v4/cli/commands/destroy/).
