...
sidebar:
  order: 14.2
slug: v4/cli/commands/plugin-show
---

Show the detail of a single [plugin](/v4/cli/configuration/#plugins-and-versions) your project uses, named by the label from
...
[`plugin list`](/v4/cli/commands/plugin-list/) to see them all.
...
Nothing beyond the project's config; like [`plugin list`](/v4/cli/commands/plugin-list/) it reads only the config blocks and
the local cache.
