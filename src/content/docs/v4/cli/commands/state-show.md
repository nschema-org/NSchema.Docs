...
sidebar:
  order: 10.5
slug: v4/cli/commands/state-show
---

Print the schema recorded in the [state store](/v4/guides/state/) as human-readable text. This is a read of what
NSchema last recorded, useful for inspecting state or diffing it against [`import`](/v4/cli/commands/import/) output.
