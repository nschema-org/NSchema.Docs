...
sidebar:
  order: 15
slug: v4/cli/commands/completion
---
...
The quickest way to enable completion permanently is [`completion install`](/v4/cli/commands/completion-install/),
...
Remove it again with [`completion uninstall`](/v4/cli/commands/completion-uninstall/):
...
offers the environment names found in the project's `*.env.<name>.sql` [overlays](/v4/cli/configuration/#environments),
