...
sidebar:
  order: 15.1
slug: v4/cli/commands/completion-install
---
...
Because the block *sources* [`nschema completion <shell>`](/v4/cli/commands/completion/) rather than embedding a copy
...
[`completion uninstall`](/v4/cli/commands/completion-uninstall/).
