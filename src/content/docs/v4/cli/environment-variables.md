...
| `NSCHEMA_ENVIRONMENT`                 | The target environment           | Selects the `*.env.<name>.sql` [overlay files](/v4/cli/configuration/#environments). Equivalent to `--environment`.    |
