...
* **A database.** This tool is for managing database schemas after all. See [Providers](/v4/providers/) for supported databases.
...
Swap `bash` for `zsh`, `fish`, or `pwsh`. See the [`completion` command](/v4/cli/commands/completion/)
for manual installation and [`completion uninstall`](/v4/cli/commands/completion-uninstall/) to remove it.

## Next steps

With the tool installed, head to the [Quickstart](/v4/start/quickstart/) to scaffold a project and apply your first schema.
