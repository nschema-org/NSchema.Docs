...
slug: v4/library/configuration
---

How to build, run, and configure an NSchema application from code. New to NSchema? Start with the [Embedding the engine](/v4/library/embedding/)
...
The desired schema is declared in SQL DDL files (see [Defining schemas](/v4/ddl/defining-schemas/) and the [grammar reference](/v4/ddl/grammar/)), loaded
