...
(see [Defining schemas](/v4/ddl/defining-schemas/)), but you could just as easily generate it from code or use an existing provider to pull it
...
interface you can swap or extend; these are covered in more detail below and in [Extension points](/v4/library/extension-points/).
...
or a [saved](/v4/library/configuration/#saved-plan-files) one).
