...
:::tip
This is an *advanced* use case. If you just want to run migrations, the [CLI](/v4/cli/) is almost certainly what you want. This section is for building on the engine itself.
:::
...
Declare your desired schema in `.sql` files using [NSchema DDL](/v4/ddl/defining-schemas/):
...
See [Configuration (C#)](/v4/library/configuration/#operations) for the full list.
...
* **[Concepts & pipeline](/v4/library/concepts/)** — the domain model and how a run flows through the engine.
* **[Configuration (C#)](/v4/library/configuration/)** — building, running, operations, policies, scoping, state, dialects, and output.
* **[Extension points](/v4/library/extension-points/)** — every interface you can swap or extend.
