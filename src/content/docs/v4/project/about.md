...
See the [Roadmap](/v4/project/roadmap/) for where things are headed and [Versioning & compatibility](/v4/project/versioning/) for what the version numbers
promise.

## License

NSchema is free and open source under the [MIT License](/v4/project/license/).
