...
For unexpected plans or migrations, the output of `nschema plan` (and a saved [plan file](/v4/cli/commands/plan/) where relevant) is especially helpful.
...
Context about the underlying need often leads to a better outcome. It's also worth checking the [Roadmap](/v4/project/roadmap/)
