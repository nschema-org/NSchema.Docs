...
description: Where to ask questions, report bugs, request features, and disclose security issues.
sidebar:
  order: 5
---

NSchema is an open-source project. The best place to get help or report a problem is the relevant GitHub repository. See
the [repository map](/project/contributing/#the-repositories).
...
- **What you expected.** What did you think would happen, and what _actually_ happened? (error messages, the plan output, exit code).
...
For unexpected plans or migrations, the output of `nschema plan` (and a saved [plan file](/cli/commands/plan/) where relevant) is especially helpful.
