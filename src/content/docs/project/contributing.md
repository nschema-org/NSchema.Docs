---
title: Contributing
description: How NSchema is organised across repositories and how to contribute code, docs, or ideas.
sidebar:
  order: 4
---
...
- **Found a bug or want a feature?** Open an issue in the most relevant repo above (see [Getting help & reporting issues](/project/support/)). 
