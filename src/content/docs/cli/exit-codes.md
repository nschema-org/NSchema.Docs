...
| `2`   | **Positive signal.** Only from the *opt-in* checks: [`plan`](/cli/commands/plan/) / [`drift`](/cli/commands/drift/) / [`lock status`](/cli/commands/lock-status/) with `--detailed-exitcode` (changes / drift / locked), and [`format --check`](/cli/commands/format/). Never returned without opting in. |
