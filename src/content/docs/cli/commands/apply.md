...
:::note[Needs]
The same inputs as [`plan`](/cli/commands/plan/), against a live database the tool can write to.
:::
...
- **`--plan-file <path>`** — replay a plan saved by [`plan --out`](/cli/commands/plan/), executing exactly that plan instead of computing 
