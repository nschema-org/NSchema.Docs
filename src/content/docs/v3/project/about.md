...
See the [Roadmap](/v3/project/roadmap/) for where things are headed and [Versioning & compatibility](/v3/project/versioning/) for what the version numbers
promise.

## License

NSchema is free and open source under the [MIT License](/v3/project/license/).
