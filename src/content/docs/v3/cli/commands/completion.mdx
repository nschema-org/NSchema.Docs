...
sidebar:
  label: completion
  order: 14
slug: v3/cli/commands/completion
---
...
Because the block *sources* `nschema completion <shell>` rather than embedding a copy of the script, your completions
...
offers the environment names found in the project's `*.env.<name>.sql` [overlays](/v3/cli/configuration/#environments),
