...
(e.g. `CREATE INDEX CONCURRENTLY`). See the [grammar reference](/v3/ddl/grammar/#deployment-scripts) for the full syntax.
...
If there's something you need a deployment script for, consider logging a feature request for it instead. \:thumbs\_up:
