...
and the exact SQL that will be executed first. You can even [save a plan to a file](/v3/cli/commands/plan/) and apply
...
domains and composite types. For anything more niche, NSchema also supports arbitrary [pre-deployment and post-deployment scripts](/v3/guides/deployment-scripts).
...
is what most people want, and what the bulk of these docs cover. Start with [Installation](/v3/start/installation/) and the
[Quickstart Guide](/v3/start/quickstart/).
...
See [Embedding the engine](/v3/library/embedding/).
