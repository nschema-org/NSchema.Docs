...
:::tip
This is an *advanced* use case. If you just want to run migrations, the [CLI](/v3/cli/) is almost certainly what you want. This section is for building on the engine itself.
:::
...
Declare your desired schema in `.sql` files using [NSchema DDL](/v3/ddl/defining-schemas/):
...
The built application is *single use*: it runs one operation and exits.
...
See [Configuration (C#)](/v3/library/configuration/#operations) for the full list.
...
* **[Concepts & pipeline](/v3/library/concepts/)** — the domain model and how a run flows through the engine.
* **[Configuration (C#)](/v3/library/configuration/)** — building, running, operations, policies, scoping, state, dialects, and output.
* **[Extension points](/v3/library/extension-points/)** — every interface you can swap or extend.
