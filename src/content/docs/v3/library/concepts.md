...
(see [Defining schemas](/v3/ddl/defining-schemas/)), but you could just as easily generate it from code or use an existing provider to pull it
...
interface you can swap or extend; these are covered in more detail below and in [Extension points](/v3/library/extension-points/).
